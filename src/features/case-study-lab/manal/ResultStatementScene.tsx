...
export default function ResultStatementScene() {
  ...
  return (
    <section ref={sectionRef} dir="rtl" className="relative isolate grid min-h-[95svh] place-items-center overflow-hidden bg-manal-deep px-5 py-28 text-manal-cream-warm sm:px-8 lg:px-12">
      ...
      <div className="mx-auto w-full max-w-6xl">
        <div data-result-line className="h-px w-full bg-gradient-to-l from-manal-gold via-manal-gold/40 to-transparent" />
        <div data-result-copy className="py-14 sm:py-20">
          <p className="text-xs font-bold tracking-[.26em] text-manal-gold-light">THE RESULT</p>
        ...
        <div data-result-line className="h-px w-full bg-gradient-to-r from-manal-gold via-manal-gold/40 to-transparent" />
      </div>
    </section>
  );
}
